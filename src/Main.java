...
public class Main {
  ...
  /**
   * The main function creates a Main object, and it instantiates a new AppWindow object to create
   * the GUI.
   *
   ...
   * @param numberOfBars The number of bars in the array. Typical use is to plug in the JSpinner
   *                     value here.
